  ...
  return (
    <div className="space-y-3 rounded-lg border border-emerald-500/20 bg-emerald-500/5 p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="ml-auto rounded bg-emerald-500/10 px-2 py-0.5 font-mono text-[11px] text-emerald-300">
          {receipt.algorithm}
        </span>
      </div>
      ...
      <div className="flex items-center gap-2 border-t border-emerald-500/10 pt-3">
        <button
          onClick={copy}
          className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-md border border-zinc-800 bg-surface-1 px-3 py-1.5 text-[12px] text-zinc-300 transition-colors hover:border-zinc-700 hover:text-zinc-100"
        >
