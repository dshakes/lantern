...
const surfaces: SurfaceDefinition[] = [
  {
    ...
    configFields: [
      { key: "phoneNumberId", label: "Phone Number ID", type: "text", placeholder: "e.g. 112233445566778", helpText: "Business API — from Meta Business Platform. Leave empty for personal mode." },
      { key: "apiToken", label: "API Token", type: "password", placeholder: "WhatsApp Business API token", helpText: "Business API — from business.facebook.com. Leave empty for personal mode." },
    ],
    // QR pairing for personal WhatsApp requires the WhatsApp Web bridge
    // service running (uses baileys/whatsapp-web.js). The QR token is
    // generated by that backend service, not the dashboard.
    hasQRCode: false
  },
  {
    id: "slack", name: "Slack",
