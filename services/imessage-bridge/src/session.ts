...
export class IMessageSession {
  ...
  private async handleOwnerDocQuery(
    ...
    const systemHint = [
      ...
      "   a. search_email — the LOCAL index of the entire mailbox (no login, always works). Run several 1-3 keyword searches (airline names, 'itinerary', 'booking confirmed', 'uscis'), not one long query.",
      "   b. gmail_search only ADDS live/full-body detail; if it errors, search_email results stand on their own.",
      "",
