...
SYNTHESIS — produce EXACTLY 4 lines, each a SINGLE bullet starting with • :
  ...
  Line 2 — UNREAD ATTENTION: 1-2 specific unread items needing his reply. Cite the person + topic ("sam asked about weekend plans" / "alex re: invoice"). Pick from messages OR email — whichever has higher-priority items.
